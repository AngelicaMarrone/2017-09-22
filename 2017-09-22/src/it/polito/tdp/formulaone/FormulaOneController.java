...
public class FormulaOneController {
    ...
    @FXML // fx:id="boxGara"
    private ComboBox<Integer> boxGara; // Value injected by FXMLLoader
    ...
    void doSelezionaStagione(ActionEvent event) {
    	...
    	List<Adiacenza> migliori = model.creaGrafo(anno);
    	
    	for (Adiacenza a: migliori)
    	{
    		txtResult.appendText("Gara 1 " + a.getId1()+ " Gara 2 "+ a.getId2()+ " Peso " + a.getPeso()+ "\n");
    	}
